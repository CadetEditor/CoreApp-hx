...
class CoreApp
{
	...
	private static var _initialised : Bool;
	private static var _fileSystemProvider : IMultiFileSystemProvider;
	private static var _resourceManager : ResourceManager;
	private static var _externalResourceFolderName : String = "assets/";
	private static var _externalResourceControllers : Dictionary; 
	
	// Getters for the managers and providers  
	private static function get_FileSystemProvider() : IMultiFileSystemProvider
	{
		return _fileSystemProvider;
    }
	
	private static function get_ResourceManager() : ResourceManager
	{
		return _resourceManager;
    }
	
	private static function get_ExternalResourceFolderName() : String
	{
		return _externalResourceFolderName;
    }
	
	private static function set_ExternalResourceFolderName(value : String) : String
	{
		_externalResourceFolderName = value;
        return value;
    }
	
	private static function get_ExternalResourceControllers() : Dictionary
	{
		return _externalResourceControllers;
    }
	
	private static function get_Initialised() : Bool
	{
		return _initialised;
    }
