...
class ChangePropertyOperation implements IUndoableOperation
{
	...
	public function new(object : Dynamic, propertyName : String, newValue : Dynamic, oldValue : Dynamic = null)
    {
		this.object = object;
		...
		if (oldValue != null) {
			...
			this.oldValue = Reflect.field(object, propertyName);
        }
    }
	
	public function execute() : Void
	{
		Reflect.setField(object, propertyName, newValue);
    }
	
	public function undo() : Void
	{
		Reflect.setField(object, propertyName, oldValue);
    }
