...
//    
// =================================================================================================    
//TODO: implement getDirectoryErrorHandler() as per local FSP  package core.app.managers.filesystemproviders.url;
...
class TraverseToDirectoryOperation extends CompoundOperation implements ITraverseToDirectoryOperation
{
	...
	private function get_FinalURI() : URI
	{
		return _finalURI;
    }
