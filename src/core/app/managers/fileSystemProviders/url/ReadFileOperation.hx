...
class ReadFileOperation extends EventDispatcher implements IReadFileOperation
{
	...
	public function execute() : Void
	{
		...
		request.contentType = URLLoaderDataFormat.BINARY; loader.addEventListener(IOErrorEvent.IO_ERROR, errorHandler);
	...
	private function loadCompleteHandler(event : Event) : Void
	{
		...
		_bytes = cast((loader.data), ByteArray);
